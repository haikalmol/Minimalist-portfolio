...
const data = useStaticQuery(
     graphql`
{
  HeroImgDesktop: file(relativePath: {eq: "detail/desktop/image-manage-hero@2x.jpg"}) {
    childImageSharp {
  ...
  HeroImgTablet: file(relativePath: {eq: "detail/tablet/image-manage-hero@2x.jpg"}) {
    childImageSharp {
  ...
  HeroImgMobile: file(relativePath: {eq: "detail/mobile/image-manage-hero@2x.jpg"}) {
    childImageSharp {
  ...
  Preview1ImgDesktop: file(relativePath: {eq: "detail/desktop/image-manage-preview-1@2x.jpg"}) {
    childImageSharp {
  ...
  Preview1ImgTablet: file(relativePath: {eq: "detail/tablet/image-manage-preview-1@2x.jpg"}) {
    childImageSharp {
      fluid(maxWidth: 689, quality: 100) {
        ...GatsbyImageSharpFluid
      }
  ...
  Preview1ImgMobile: file(relativePath: {eq: "detail/mobile/image-manage-preview-1@2x.jpg"}) {
    childImageSharp {
  ...
  Preview2ImgDesktop: file(relativePath: {eq: "detail/desktop/image-manage-preview-2@2x.jpg"}) {
    childImageSharp {
      fluid(maxWidth: 635, quality: 100) {
        ...GatsbyImageSharpFluid
      }
  ...
  Preview2ImgTablet: file(relativePath: {eq: "detail/tablet/image-manage-preview-2@2x.jpg"}) {
    childImageSharp {
      fluid(maxWidth: 689, quality: 100) {
        ...GatsbyImageSharpFluid
      }
  ...
  Preview2ImgMobile: file(relativePath: {eq: "detail/mobile/image-manage-preview-2@2x.jpg"}) {
    childImageSharp {
      fluid(maxWidth: 313, quality: 100) {
        ...GatsbyImageSharpFluid
      }
